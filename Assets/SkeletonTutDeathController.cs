...
public class SkeletonTutDeathController : EnemyDeathBehaviourBase
{
    ...
    public override void DoDeath()
    {
        ...
        _gameMasterController.ShowGoodAndGoNext(GameMasterController.EnumGameStatus.TutMushroom);
    }
